...
ResultSet rs1,rs2;
int total_colleges=0;
Statement stat1=con.createStatement();
rs1 = stat1.executeQuery("select count(*) as 'count' from members where jurisdiction='College';");
while(rs1.next()){
 total_colleges= rs1.getInt("count");
}
%>
	<div class="button-container" style="text-align:center;">
		<button class="btn btn-success btn-lg" style="width:350px;"><b>Total Colleges
				Registered<br><%out.println(total_colleges);%></b></button>
	</div>
	<br>
...
rs2 = stat2.executeQuery("select mcollege,mfirstname,mlastname,memail from members where jurisdiction='College';");
while(rs2.next()){
out.println("<tr><td>"+rs2.getString("mcollege")+"</td><td>"+rs2.getString("mfirstname")+" "+rs2.getString("mlastname")+"</td><td>"+rs2.getString("memail")+" <a href=\"mailto:"+rs2.getString("memail")+"?Subject=Regd\" target=\"_top\"><img src=\"ASSETS\\mail.png\"></a>"+"</td></tr>");
} %>
		</tbody>
	</table>
	<br>
